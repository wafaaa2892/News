...
export default function Sports() {
    ...
    async function getData(){
        let infoData = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=53d413b09da8406f8c343a1e718cde1c`);
    ...
    <div className="container">
        <div className="row">
            <h1 className={`${style.head1} text-center`}>US Sports News</h1>
            {newsApi.map((element)=>
                <div className="col-md-3 mt-5">
                    ...
                    <div className={`${style.cards1} text-center`}>
                        ...
                        <div className={`${style.cardBody} w-100 h-100 text-center pt-5 mb-5`}>
